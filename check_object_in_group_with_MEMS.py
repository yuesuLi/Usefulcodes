...
def get_args():
    ...
    parser.add_argument('--root_dataset', type=str, default='/mnt/ourDataset_v2/ourDataset_v2_label', help='MEMS path')
    parser.add_argument('--root_label', type=str, default='/mnt/ourDataset_v2/raw_data/labels_for_checking2', help='labelroot path')
