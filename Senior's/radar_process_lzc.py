...
if __name__ == '__main__':
    # base_path = './20211027_1_group0028_134frames_27labeled'
    ...
    for folder in folders:
        ...
        # pts_sequence(img_path, read_pcd(pcd_lidar), calib_lidar)
        # pts_sequence(img_path, read_pcd(pcd_radar), calib_radar)
        # break
