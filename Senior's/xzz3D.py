...
def draw_3D_Box(camera_label_dir, camera_image_dir, lidar_label_dir):
    assert 'json' in camera_label_dir
    with open(camera_label_dir) as f_camera_label:
        camera_label = json.load(f_camera_label)
    # print(camera_label)
...
# camera_label_dir = '/media/ourDataset/v1.0_label/20211031_3_group0017_100frames_20labeled/20211031_3_group0017_frame0095_labeled/LeopardCamera1/1635684669.059.json'
# camera_image_dir = '/media/ourDataset/v1.0_label/20211031_3_group0017_100frames_20labeled/20211031_3_group0017_frame0095_labeled/LeopardCamera1/1635684669.059.png'
# lidar_label_dir = '/media/ourDataset/v1.0_label/20211031_3_group0017_100frames_20labeled/20211031_3_group0017_frame0095_labeled/VelodyneLidar/1635684668.629.json'
# lidar_point_dir = '/media/ourDataset/v1.0_label/20211031_3_group0017_100frames_20labeled/20211031_3_group0017_frame0095_labeled/VelodyneLidar/1635684668.629059315.pcd'
# radar_label_dir = '/media/ourDataset/v1.0_label/20211031_3_group0017_100frames_20labeled/20211031_3_group0017_frame0095_labeled/TIRadar/1635684668.622.json'
# radar_point_dir = '/media/ourDataset/v1.0_label/20211031_3_group0017_100frames_20labeled/20211031_3_group0017_frame0095_labeled/TIRadar/1635684668.622.pcd'


# base_path = '/media/ourDataset/v1.0_label/20211025_1_group0005_155frames_31labeled/20211025_1_group0005_frame0000_labeled'
# camera_label_dir = os.path.join(base_path, 'LeopardCamera1', '1635145120.915.json')
# camera_image_dir = os.path.join(base_path, 'LeopardCamera1', '1635145120.915.png')
# lidar_label_dir = os.path.join(base_path, 'VelodyneLidar', '1635145120.294.json')

# base_path = '/media/ourDataset/v1.0_label/20211027_1_group0021_123frames_25labeled/20211027_1_group0021_frame0050_labeled'
# camera_label_dir = os.path.join(base_path, 'LeopardCamera1', '1635319102.927.json')
# camera_image_dir = os.path.join(base_path, 'LeopardCamera1', '1635319102.927.png')
# lidar_label_dir = os.path.join(base_path, 'VelodyneLidar', '1635319102.359.json')
...
# '/media/ourDataset/v1.0_label/20211031_3_group0017_100frames_20labeled/' \
# '20211031_3_group0017_frame0095_labeled/LeopardCamera1/1635684669.059.json'
# '/home/zhangq/Desktop/ourDataset/v1.0_label/20211025_1_group0012_185frames_37labeled/
# 20211025_1_group0012_frame0045_labeled/LeopardCamera1/1635145269.477.png'
# '/home/zhangq/Desktop/ourDataset/v1.0_label/20211025_1_group0012_185frames_37labeled/' \
# '20211025_1_group0012_frame0045_labeled/VelodyneLidar/1635145269.014.json'